...
canvas = Canvas(frame_top, width=30, height=30, bg='white')
canvas.pack(side=LEFT,padx=10, pady=5)
canvas.create_rectangle(0, 0, 29, 29, fill='green', outline='black')

label = Label(frame_top, text="Свободно", fg="black",font=("Arial", 10))
label.pack(side=LEFT,padx=10, pady=5)
canvas = Canvas(frame_top, width=30, height=30, bg='white')
canvas.pack(side=LEFT,padx=10, pady=5)
canvas.create_rectangle(0, 0, 29, 29, fill='red', outline='black')
